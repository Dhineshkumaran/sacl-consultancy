...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="dashboard" style={{ background: 'linear-gradient(135deg, #FF9C00 0%, #FFB84D 30%, #FFFFFF 50%, #8A8F94 70%, #6C757D 100%)', minHeight: '100vh', fontFamily: "'Poppins', sans-serif" }}>
