...
router.post('/', verifyToken, authorizeDepartment(1, 7), asyncErrorHandler(pouringDetailsController.createPouringDetails));
router.put('/', verifyToken, authorizeDepartment(1, 7), authorizeRoles('Admin', 'HOD'), asyncErrorHandler(pouringDetailsController.updatePouringDetails));
