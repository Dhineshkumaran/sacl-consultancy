...
router.post('/', verifyToken, authorizeDepartment(1, 2), asyncErrorHandler(trialController.createTrial));
...
router.put('/update', verifyToken, authorizeDepartment(1, 2), authorizeRoles('Admin', 'HOD'), asyncErrorHandler(trialController.updateTrial));
