...
router.post('/', verifyToken, authorizeDepartment(1, 10), asyncErrorHandler(dimensionalInspectionController.createInspection));
router.put('/', verifyToken, authorizeDepartment(1, 10), authorizeRoles('Admin', 'HOD'), asyncErrorHandler(dimensionalInspectionController.updateInspection));
